...
<p>
    ...
    //SEVENTH TASK
    //Value is string. Value is double. Value is boolean.
    ...
    echo '<span>Value is </span>' . gettype($value1);
    echo '<span>. Value is </span>' . gettype($value2);
    echo '<span>. Value is </span>' . gettype($value3);
    echo '<span>. Value is </span>' . gettype($value4);
    echo '<span>. Value is </span>' . gettype($value5);
    echo '<span>.</span>'
